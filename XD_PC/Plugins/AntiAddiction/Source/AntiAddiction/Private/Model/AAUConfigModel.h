...
#include "AAUConfigModel.generated.h"
...
USTRUCT()
struct FAAUChildProtectedConfig
{
	GENERATED_BODY()
...
USTRUCT()
struct FAAUHealthReminderWordTip
{
	GENERATED_BODY()
...
struct FAAUHealthReminderWord
{
	...
	UPROPERTY()
	TArray<FAAUHealthReminderWordTip> tips;
...
struct FAAUUIConfig
{
	...
	UPROPERTY()
	TArray<FAAUPayLimitWord> pay_limit_words;

	UPROPERTY()
	TArray<FAAUHealthReminderWord> health_reminder_words;

	UPROPERTY()
	TArray<FAAUAuthIdentifyWord> auth_identify_words;  // 见AAURealNameWordType 
	
};

USTRUCT()
struct FAAUConfigModel
{
	GENERATED_BODY()
	...
	UPROPERTY()
	FAAUChildProtectedConfig child_protected_config;

	UPROPERTY()
	FAAUUIConfig ui_config;
